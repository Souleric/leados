...
import { teamMembers as mockTeam } from "@/lib/mock-data";
          ...
          {members.map((m, i) => (
            ...
            >
              <div
                ...
                style={{ backgroundColor: m.avatarColor + "20" }}
              >
                <span className="text-[11px] font-bold" style={{ color: m.avatarColor }}>
              ...
              <select
                ...
                onChange={(e) =>
                  setMembers((prev) =>
                    prev.map((mem) =>
                      mem.id === m.id
                        ? { ...mem, role: e.target.value as "admin" | "agent" | "viewer" }
                        : mem
                    )
                  )
                }
