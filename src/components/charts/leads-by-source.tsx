...
import { leadsBySource } from "@/lib/mock-data";
  ...
  return (
    <div className="bg-white dark:bg-white/[0.04] rounded-2xl border border-slate-100/80 dark:border-white/[0.06] p-5">
      <div className="flex items-center justify-between mb-5">
        <div>
          <h3 className="text-sm font-bold text-slate-800 dark:text-white">Revenue Updates</h3>
      ...
      <ResponsiveContainer width="100%" height={200}>
        <BarChart data={leadsBySource} margin={{ top: 5, right: 5, left: -25, bottom: 0 }}>
