...
const DEMO_CAMPAIGNS: Campaign[] = [
  ...
  { id: "d4", name: "Home Renovation Q1",       platform: "Instagram", status: "active", spend: 4100,  impressions: 120000, clicks: 2300, leads_count: 72, cpl: 56.94,  cpm: 34.17,  cpc: 1.78,  start_date: "2024-01-15", end_date: "2024-03-31", last_synced_at: new Date().toISOString(), meta_campaign_id: "demo" },
